...
The **Analyzer** step runs on the Microsoft engineer's local machine. It
...
> Excel dependency. The customer collects and shares the JSON; the MS
> engineer generates the workbook locally.
...
CSA notes, overriding fields) to republish a machine-readable version that
...
is the primary deliverable for the CSA engagement — fill it in based on your
